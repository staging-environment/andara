		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="about-item-img">
					<img loading="lazy" src="images/about-us.jpg" alt="about-image" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
...
<section class="team-info section bgYellow">
	<h2 class="text-yellow">Conócenos</h2>
	<div class="row justify-content-center">
			<div class="col-lg-4 col-md-6 col-sm-6">
					...
					<div class="team-item position-relative">
						...
						<div class="team-img-hover">
							<ul class="team-social list-inline">
								...
								<li class="list-inline-item">
									<a href="https://linkedin.com/" class="linkedin"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a>
								</li>
							</ul>
						</div>
					</div>
